...
export function CustomerDetail() {
  ...
  return (
    <div className="page">
      <Link to="/customers" className="text-accent font-medium no-underline hover:underline text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-5">
        ...
        <div className="bg-bg-card border border-border rounded-[--radius-card] p-6">
          <h2 className="text-base font-semibold mb-4">Pedidos ({customer.orders?.length || 0})</h2>
          <table className="table w-full">
            ...
            <tbody>
              ...
              {(!customer.orders || customer.orders.length === 0) && (
                <tr><td colSpan={4} className="text-center text-text-muted py-8">Nenhum pedido</td></tr>
              )}
            </tbody>
          </table>
        </div>
